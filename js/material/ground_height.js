function GroundHeightMaterial(name, textureSize, ground, grid, scene) {
    this.name = name;
    this.id = name;
...
// Methods
GroundHeightMaterial.prototype.getRenderTargetTextures = function () {
...
GroundHeightMaterial.prototype.dispose = function(){
    this.baseDispose();
};
